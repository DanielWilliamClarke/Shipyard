...
int main()
{
	...
	std::map<int, std::pair<std::string, std::function<void(void)>>> options{
		...
		{6, std::make_pair("Get Vessel from System", [&lib](void) -> void { lib->GetVessel(); })},
		{7, std::make_pair("Delete Vessel from System", [&lib](void) -> void { lib->DeleteVessel(); })},
		{8, std::make_pair("Simulate Hydrophone", [&lib](void) -> void { lib->Hydrophone(); })},
		{9, std::make_pair("Exit", [=](void) -> void { throw ExitException("Goodbye!"); })}
	};
